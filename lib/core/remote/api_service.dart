...
import 'package:weather_app_master/core/remote/api_interface.dart';
...
class ApiService implements ApiInterface {
  ...
  Future<T> setData<T>({
    ...
    //   debugPrint("pesan error ${response.body['message']}");
    //   throw CustomException(message: response.body['message']);
    // }
    ...
    try {
      ...
      throw CustomException.fromDioException(ex);
      // debugPrint("error gan $ex");
      // throw CustomException(
      //     message: ex.response?.data['message'] ?? "Terjadi Error",
