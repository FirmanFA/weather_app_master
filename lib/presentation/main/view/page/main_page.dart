              ...
              body: SafeArea(
                ...
                success: (data) {
                  ...
                  return GestureDetector(
                    onTap: () {
                      controller.cityOverlayPortalController.hide();
                    },
                    child: Column(
                      children: [
                        24.verticalSpace,
                        MainHeaderWidget(
                          selectedCity: controller.selectedCityString.value,
                          onHeaderClick: () {
                            controller.cityOverlayPortalController.toggle();
                          },
                          overlayPortalController:
                              controller.cityOverlayPortalController,
                                        ...
                                        itemBuilder: (context, item, index) {
                                          return GestureDetector(
                                            ...
                                            child: Padding(
                                              ...
                                              child: Text(item.name?.replaceAll(
                                                      "KABUPATEN", "") ??
                                                  ""),
                                            ),
                                          );
                        ...
                        WeatherAdditionalInfoWidget(
                            ...
                            weatherForecastState:
                                controller.weatherForecastState.value),
                        const Spacer(),
